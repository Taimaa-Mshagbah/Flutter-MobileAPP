...
class UserAuthenticationPage extends StatefulWidget {
  static const namedRoute = '/authentication_page_user';
  @override
...
class _UserAuthenticationPageState extends State<UserAuthenticationPage> {
  ...
  void _startAuthProcess() async {
    ...
    try {
      ...
      if (_isLogin) {
        success =
            await Provider.of<AuthenticationProvider>(context, listen: false)
                .signInUser(_enteredEmail, _enteredPassword);
      } else {
      ...
      if (success) {
        Navigator.of(context).pushReplacementNamed(ShowSectionsPage.namedRoute);
      }
    } catch (error) {
